            ...
            <Card key={brief.id} className="hover:shadow-md transition-shadow">
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-3">
                  {brief.target_market && (
                    <div>
                      <div className="text-xs font-medium text-slate-900 mb-1">Target Market</div>
                      <p className="text-xs text-slate-600 line-clamp-2">{brief.target_market}</p>
                    </div>
                  )}

                  {(brief.price_point_min || brief.price_point_max) && (
                    <div className="flex items-center justify-between">
                      <span className="text-xs text-slate-600">Price Range</span>
                  ...
                  {(brief.materials_preference || []).length > 0 && (
                    <div>
                      <div className="text-xs font-medium text-slate-900 mb-2">Materials</div>
      ...
      {filteredBriefs.length === 0 && (
        <Card>
          <CardContent className="text-center py-12">
            ...
            <h3 className="mt-2 text-sm font-medium text-slate-900">No briefs found</h3>
