      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4 md:gap-6 mb-8">
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-sm text-slate-600">All time revenue</p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-sm text-slate-600">Orders in progress</p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-sm text-slate-600">Items in production</p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-sm text-slate-600">Product collections</p>
          </CardContent>
        </Card>
      </div>
