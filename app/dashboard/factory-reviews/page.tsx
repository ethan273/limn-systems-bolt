  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-slate-900">Factory Reviews</h1>
          <p className="text-slate-600 mt-1">Manage prototype reviews, shop drawing approvals, and revision workflows</p>
        </div>
            ...
            {reviewSessions.filter(session => session.status !== 'completed').length === 0 && (
              <Card>
                <CardContent className="pt-12 pb-12 text-center">
                  <Factory className="w-16 h-16 text-slate-500 mx-auto mb-4" />
                  <h3 className="text-lg font-medium text-slate-900 mb-2">No active review sessions</h3>
                  <p className="text-slate-600 mb-4">Start a new factory review session to begin the prototype approval process</p>
                  <Link href="/dashboard/factory-reviews/new-session">
                    <Button>
                      <Plus className="h-4 w-4 mr-2" />
                      Create New Session
                ...
                <CardContent className="pt-6">
                  <div className="flex items-start justify-between">
                    <div className="space-y-2">
                      <div>
                        <h3 className="text-lg font-medium text-slate-900">{revision.prototype_name}</h3>
                        <p className="text-sm text-slate-600 mt-1">{revision.description}</p>
                      </div>
                      <div className="flex items-center space-x-3">
        ...
        <TabsContent value="history" className="space-y-4">
          <Card>
            <CardContent className="pt-12 pb-12 text-center">
              ...
              <h3 className="text-lg font-medium text-slate-900 mb-2">Review History</h3>
              <p className="text-slate-600">Completed review sessions and historical data will appear here</p>
            </CardContent>
          </Card>
        </TabsContent>
      </Tabs>
